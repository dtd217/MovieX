      ...
      <div className='lg:w-1/4 lg:inline-block w-full block lg:pl-4 lg:mt-0 mt-5'>
         ...
         <section className="p-3 h-auto mb-5 rounded-md bg-[#78909c] bg-opacity-20">
            <div className="text-white mb-6 font-semibold pb-4 text-base flex flex-col">
               <span className='text-lg font-bold text-center mb-4 uppercase'>Phim hay</span>
               <div className='flex'>
                  <button
                     className={`${isClicked ? '!border-[#b5e745] text-red-400' : 'border-transparent text-white'}   hover:text-red-700 hover:bg-gray-200 w-1/2 text-center p-2 rounded-t-md border-b-4 text-lg cursor-pointer duration-200 font-bold ease-in`}
