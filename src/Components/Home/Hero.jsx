               ...
               <SwiperSlide>
                  <div key={index}>
                     <Link to={`/movie/${movie?.slug}`} className='relative w-full h-full block'>
                        <img src={movie?.banner} alt={movie?.title} className='w-full  h-auto rounded-md object-cover lg:object-fill max-w-full object-top hover:opacity-90 duration-100 ease-in' />
                     </Link>
                     {/* PC */}
                     <div className='absolute lg:block hidden w-1/2 bg-opacity-40 h-full text-white top-0 left-0 bg-black rounded-l-md overflow min-w-min'>
                        <div className="p-5 block">
                           <Link to="/about" className='font-semibold hover:text-red-500 transitions'>
                           ...
                           <Link to="/about" className="font-semibold bg-red-600 mr-1.5 flex items-center justify-center rounded py-2.5 px-5 max-w-fit hover:bg-gray-600 duration-200 ease-in">
                     ...
                     <div className='relative block lg:hidden w-full h-full text-white'>
                        <div className="p-5 block bg-[#78909c] bg-opacity-30 h-full rounded-b-md">
                           ...
                           <Link to="/about" className="font-semibold bg-red-600 mr-1.5 flex items-center justify-center rounded py-2.5 px-5 max-w-fit hover:bg-gray-600">
                              <svg className="w-4 h-3 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 10 16">
                                 <path d="M3.414 1A2 2 0 0 0 0 2.414v11.172A2 2 0 0 0 3.414 15L9 9.414a2 2 0 0 0 0-2.828L3.414 1Z" />
                              </svg>
                              Watch Now
